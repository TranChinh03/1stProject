 ...
 */
declare type ModuleValue = null | string | number | boolean | Tensor | {
 ...
 */
declare type ModuleInputValue = string | number | boolean | Tensor;
export interface Module {
     ...
     */
    forward<In extends ModuleInputValue, Out extends ModuleValue>(...inputs: In[]): Promise<Out>;
    /**
     ...
     * the [[ModuleValue]] union types.
     */
    forwardSync<In extends ModuleInputValue, Out extends ModuleValue>(...inputs: In[]): Out;
}
interface JIT {
    /**
 ...
 */
export declare type Dtype = 'double' | 'float' | 'float32' | 'float64' | 'int' | 'int16' | 'int32' | 'int64' | 'int8' | 'long' | 'short' | 'uint8';
export declare type TensorOptions = {
    /**
 ...
 */
export declare type MemoryFormat = 'channelsLast' | 'contiguousFormat' | 'preserveFormat';
...
export interface Tensor {
     ...
     */
    add(other: Scalar | Tensor, options?: {
        alpha?: Number;
    }): Tensor;
    /**
     ...
     */
    div(other: Scalar | Tensor, options?: {
     ...
     * @param options.alpha The multiplier for `other`. Default: `1`.
     */
    sub(other: Scalar | Tensor, options?: {
        alpha?: Number;
    }): Tensor;
    /**
